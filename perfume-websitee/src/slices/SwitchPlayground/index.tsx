  ...
  return (
    ...
    >
      <FadeIn>
        ...
        <FadeIn targetChildren className='grid grid-cols-1 overflow-hidden sm:grid-cols-2'>
...
const SharedCanvas = ({color} : SharedCanvasProps) => {
  ...
  const handleSound = () => {
    const selectSound = gsap.utils.random(SOUND_MAP[colorName]);
      ...
      >
        ...
        >
          <text 
            ...
            textAnchor="middle"
            fontSize={18}
            className="font-black-slanted fill-white/30 mix-blend-overlay group-hover:fill-white/100 motion-safe:transition-all motion-safe:duration-700">
