...
/**
 * Primary content in *Heroo → Default → Primary*
 */
export interface HerooSliceDefaultPrimary {
  /**
   * Heading field in *Heroo → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *Heroo → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Buy Button Text field in *Heroo → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: heroo.default.primary.buy_button_text
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
...
/**
 * Default variation for Heroo Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
